...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": ("apps.users.authentications.CookieJWTAuthentication",),
    "EXCEPTION_HANDLER": "apps.core.exception_handlers.universal_exception_handler",
