...
from apps.users.views.email_view import (
    ...
    SignUpEmailVerifiCationVerifyAPIView, PasswordResetEmailVerificationSendAPIView,
    AccountRecoveryEmailVerificationSendAPIView, PassowrdResetEmailVerificationVerifyAPIView,
...
urlpatterns = [
    ...
    path("auth/reset-password/verify", PassowrdResetEmailVerificationVerifyAPIView.as_view(), name="password_reset_verify"),
    path("auth/recover-account/sned", AccountRecoveryEmailVerificationSendAPIView.as_view(), name="recover_account_send"),
    path("auth/recover-account/verify", AccountRecoveryEmailVerificationVerifyAPIView.as_view(), name="recover_account_verify"),
