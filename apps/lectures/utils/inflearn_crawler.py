...
def crawl_inflearn_courses():
    ...
    try:
        ...
        response = requests.get(base_url, params={"pageNumber": 1, "pageSize": page_size, "sort": "POPULAR", "lang": "ko"})
        ...
        for page_num in range(1, total_page + 1):
            ...
            params = {"pageNumber": page_num, "pageSize": page_size, "sort": "POPULAR", "lang": "ko"}
